...
def current_occupancy_counter(session, this_shelter_id):
    ...
    logging.info( "puppy_count is: ", puppy_count )
    return puppy_count
...
def remaining_capacity_counter(session, this_shelter_id):
    ...
    logging.info( "remaining capacity is:", remaining_capacity )
...
def load_balancer(session, this_puppy_id):
    ...
    logging.info( remaining_capacity_list )
    logging.info( remaining_capacity_list.index(max(remaining_capacity_list)) )
...
def adopt_puppy(session, puppy_id, adopter_id):
    ...
    logging.info( "update_puppy_result: ", update_puppy_result )
...
def before_flush(session, flush_context, instances):
    ...
    for each in session.new:
        ...
        if each.__tablename__ == "puppy":
            logging.info( "each.shelter_id is: ", each.shelter_id )
